...
const EMAIL_SUBJECTS: Record<string, string> = {
  signup: 'Confirma tu email — IamBlessedAF',
  invite: 'Te invitaron a IamBlessedAF 🙏',
  magiclink: 'Tu link de acceso — IamBlessedAF',
  recovery: 'Restablece tu contraseña — IamBlessedAF',
  email_change: 'Confirma tu cambio de email — IamBlessedAF',
  reauthentication: 'Tu código de verificación — IamBlessedAF',
}
...
// Configuration
const SITE_NAME = "IamBlessedAF"
const SENDER_DOMAIN = "notify.iamblessedaf.com"
const ROOT_DOMAIN = "iamblessedaf.com"
const FROM_DOMAIN = "iamblessedaf.com" // Domain shown in From address (may be root or sender subdomain)
...
const SAMPLE_PROJECT_URL = "https://conversion-architects-hub.lovable.app"

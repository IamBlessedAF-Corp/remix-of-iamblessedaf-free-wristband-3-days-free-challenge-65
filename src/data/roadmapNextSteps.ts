...
export const PHASE_NEXT_STEPS: Record<string, NextStepItem[]> = {
  ...
  gamification: [
    ...
    { title: "Add referral tree visualization", detail: "Visual tree showing downstream referrals, earnings per branch, network growth over time", priority: "medium" },
  ],
  ops: [
  ...
  comms: [
    { title: "Build Soap Opera email sequence engine", detail: "5-email drip: backstory → conflict → epiphany → transformation → call-to-action", priority: "critical" },
    ...
    { title: "Add unsubscribe analytics dashboard", detail: "Track unsubscribe rates by channel, campaign, send frequency correlation", priority: "low" },
    ...
    { title: "Add email open/click tracking", detail: "Pixel tracking for opens, link wrapping for clicks, per-campaign engagement metrics", priority: "high" },
    { title: "Build notification preference center", detail: "User-facing settings page to control email, SMS, and push notification preferences per category", priority: "medium" },
    { title: "Add transactional email templates library", detail: "Branded templates for order confirmation, shipping, tier unlock, password reset", priority: "medium" },
  ],
  conversion: [

...
/* ─── Data ─── */
const STATS = [
  { value: "3.1x", label: "More DM Replies", icon: MessageCircle },
  { value: "67%", label: "Higher Engagement", icon: TrendingUp },
  { value: "$0", label: "Cost to You", icon: Gift },
  { value: "11", label: "Meals per Gift", icon: Heart },
];
        ...
        <div className="relative max-w-3xl mx-auto px-4 pt-10 pb-16 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <h1 className="text-3xl md:text-5xl font-black text-foreground leading-[1.1] mb-4 tracking-tight">
              Stop Cold DM'ing.{" "}
              <span className="text-primary">Gift a FREE Wristband</span>
              <br className="hidden md:block" />
              & Watch Your DMs Explode 🔥
            </h1>
            <p className="text-base md:text-lg text-muted-foreground max-w-xl mx-auto mb-6 leading-relaxed">
              Repost <strong className="text-foreground">viral neuroscience clips</strong>, offer a{" "}
              <strong className="text-foreground">FREE physical wristband</strong>, capture emails & phone numbers —
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25 }}>
            ...
            >
              YES! Give Me the Strategy — FREE <ArrowRight className="w-5 h-5" />
            </Button>
            <p className="text-xs text-muted-foreground mt-2">
              100% free. No credit card. Works with any network or product.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="max-w-3xl mx-auto px-4 py-14">
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
          ...
          <p className="text-sm text-muted-foreground text-center mb-8">
            Total value: $5,500+ — yours at zero cost when you join.
          </p>
      ...
      <section id="enroll-section" className="max-w-3xl mx-auto px-4 py-16">
        <motion.div className="max-w-md mx-auto" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
          <div className="text-center mb-6">
            <Badge className="mb-3 bg-primary/10 text-primary border-primary/20 text-xs font-bold">
              <Rocket className="w-3 h-3 mr-1" /> FREE STRATEGY KIT
            </Badge>
            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-2">
              Get Your <span className="text-primary">Gift-First Strategy Kit</span>
            </h2>
            <p className="text-sm text-muted-foreground">
              Clip library, DM scripts, wristband gifting system — all FREE. Start getting warm leads today.
            </p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="bg-card border border-border/40 rounded-2xl p-6 space-y-4">
              ...
              >
                {submitting ? (
                  ...
                  <>YES! Send Me the FREE Strategy Kit <ArrowRight className="w-5 h-5" /></>
                )}
              </Button>

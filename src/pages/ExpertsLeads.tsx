...
const HOW_STEPS = [
  {
    ...
    desc: "A full lead-capture funnel customized with YOUR branding, YOUR offer, and YOUR voice — ready to deploy in 48 hours.",
  },
  {
    icon: TrendingUp,
    title: "Reactivate Your List & Past Clients",
    desc: "Our proven reactivation system re-engages your existing contacts with personalized outreach that gets 2.7x more responses than generic emails.",
  },
  {
    icon: Sparkles,
    title: "Capture Warm Leads on Autopilot",
    desc: "Every visitor enters your funnel, gets nurtured automatically, and books calls — while you focus on coaching.",
  },
  {
    icon: Rocket,
    title: "2.7x More Leads, Zero Extra Spend",
    desc: "The same system behind 7 Inc 5000 companies. No ad spend required — just smarter funnels and better follow-up.",
  },
];
...
const TESTIMONIALS = [
  {
    ...
    img: coachSarahImg,
    quote: "I replaced my old lead magnet with this funnel system and my show-up rate went from 22% to 61%. The reciprocity effect is REAL — when people feel valued upfront, they show up.",
    results: [
  ...
  },
  {
    ...
    img: coachMarcusImg,
    quote: "My pipeline has never been this full. Every lead who came through the funnel booked a call within 48 hours. The reactivation system alone was worth it.",
    results: [
  ...
  },
  {
    ...
    img: coachDianaImg,
    quote: "The credibility this system builds is incredible. When prospects see the funnel, the trust is instant. I've 3x'd my practice in 90 days.",
    results: [
          ...
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
            <div className="text-center mb-10">
              ...
              <p className="text-sm text-muted-foreground max-w-md mx-auto">
                They upgraded their lead capture. Here's what happened.
              </p>
            </div>
      ...
      <section className="bg-foreground">
        <div className="max-w-3xl mx-auto px-4 py-14 text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-background mb-3">
            Stop Competing. Start <span className="text-primary">Growing.</span>
          </h2>
          <p className="text-sm text-background/70 max-w-md mx-auto mb-6">
            While other coaches fight over the same tired lead magnets, you'll have
            a proven system that captures and converts leads on autopilot.
          </p>

...
export default function ExpertsLeads() {
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 right-0 p-5">
            <p className="text-xs font-bold text-primary uppercase tracking-wider mb-1">
              What Your Leads Receive
            </p>
            <h3 className="text-lg font-bold text-foreground">
              A Real, Waterproof Gratitude Wristband — Shipped FREE
            </h3>
            <p className="text-xs text-muted-foreground mt-1">
              Debossed • One-size-fits-all • Premium nylon • Ships worldwide
            </p>
          </div>
        </motion.div>
      </section>
        ...
        <div className="max-w-3xl mx-auto px-4 py-14">
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
            ...
            <div className="rounded-xl overflow-hidden border border-border/40 mb-8">
              <img
                src={hawkinsImg}
                alt="Dr. Hawkins consciousness scale showing gratitude at 540"
              ...
              {VALUE_STACK.map((v, i) => (
                <div
                  ...
                  className={`flex items-center justify-between px-5 py-3.5 ${
                    i < VALUE_STACK.length - 1 ? "border-b border-border/30" : ""
                  }`}
                >
          ...
          <form onSubmit={handleSubmit} className="bg-card border border-border/40 rounded-2xl p-6 space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                placeholder="e.g. Mindset Coach, Business Consultant"
                className="h-11"
              />
            </div>
            <Button
      ...
      {/* ═══ FAQ ═══ */}
      <section className="bg-card border-t border-border/30">
        <div className="max-w-3xl mx-auto px-4 py-14">

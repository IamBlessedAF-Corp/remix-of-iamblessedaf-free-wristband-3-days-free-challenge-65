...
const Terms = () => {
  ...
  useEffect(() => {
    document.title = "Terms & Conditions | I am Blessed AF";
    ...
    setMeta("og:title", "Terms & Conditions | I am Blessed AF");
    setMeta("og:description", "Terms of use for the I am Blessed AF platform — Gratitude Challenge, Clipper Program, Blessed Coins, SMS, and more.");
    setMeta("og:image", "/og-image.png");
    setMeta("og:type", "website");
    setMeta("twitter:card", "summary_large_image");
    setMeta("twitter:title", "Terms & Conditions | I am Blessed AF");
    setMeta("twitter:description", "Terms of use for the I am Blessed AF platform.");
      ...
      <main className="max-w-3xl mx-auto px-4 py-8">
        ...
        >
          ...
          <Section title="1. Agreement to Terms">
            <p>
              By accessing or using the I am Blessed AF platform, including all associated
          ...
          <Section title="2. Description of Service">
            <p>
              <strong>I am Blessed AF</strong> is a gratitude-driven community platform that
              enables users to:
            </p>
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>Join the <strong>Ambassador &amp; Clipper Program</strong> — a creator incentive system where participants earn rewards by creating and sharing video clips promoting the I am Blessed AF mission.</li>
          ...
          <Section title="3. SMS &amp; Messaging Program">
            <div className="bg-muted/50 border border-border rounded-lg p-4 space-y-3">
              <p className="font-semibold text-foreground">📱 I am Blessed AF SMS Program</p>
              <ul className="list-disc pl-5 space-y-1">
                <li><strong>Program Name:</strong> I am Blessed AF Gratitude Challenge &amp; Notifications</li>
          ...
          <Section title="8. Clipper &amp; Ambassador Program">
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>I am Blessed AF reserves the right to modify payout rates, bonus structures, and program terms at any time with reasonable notice.</li>
          ...
          <Section title="13. Intellectual Property">
            <p>
              All content, branding, designs, and software associated with I am Blessed AF are
          ...
          <Section title="16. Limitation of Liability">
            <p>
              To the maximum extent permitted by law, I am Blessed AF shall not be liable for
          ...
          <Section title="18. Contact Us">
            ...
            <p className="font-semibold text-foreground">
              Email: support@iamblessedaf.com
            </p>
            <p>

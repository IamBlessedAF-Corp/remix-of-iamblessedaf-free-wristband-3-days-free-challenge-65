...
const HOW_STEPS = [
  {
    ...
    desc: "A full lead-capture and reactivation funnel customized with YOUR branding, designed specifically for real estate professionals.",
  },
  {
    icon: Phone,
    title: "Reactivate Your Past Client Database",
...
const TESTIMONIALS = [
  {
    ...
    img: coachSarahImg,
    quote: "I texted 50 past clients with a personalized outreach. 38 responded within 24 hours. THREE asked about listing their homes. My dead database came alive overnight — and I looked like a hero, not a salesperson.",
    results: [
  ...
  },
  {
    ...
    img: coachMarcusImg,
    quote: "My team of 8 agents each got the funnel system. We started using it at open houses and in our follow-ups. People actually remembered us. Every touchpoint builds the relationship.",
    results: [
  ...
  },
  {
    ...
    img: coachDianaImg,
    quote: "I post value-first content on Instagram and drive to my funnel. My DMs went from 2/day to 25/day. People say 'I love that you're about more than just selling houses.' That's the whole point — and it WORKS.",
    results: [
          ...
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
            <div className="text-center mb-10">
              ...
              <p className="text-sm text-muted-foreground max-w-md mx-auto">
                From dead databases to flooded DMs — powered by a smarter funnel.
              </p>
            </div>
          ...
          <Card className="border-primary/20 overflow-hidden">
            <CardContent className="p-0">
              ...
              <div className="flex items-center justify-between px-5 py-3.5 border-b border-border/30">
                ...
                <span className="text-lg font-black text-muted-foreground line-through">$15,700</span>
              </div>
      ...
      <section className="bg-foreground">
        <div className="max-w-3xl mx-auto px-4 py-14 text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-background mb-3">
            Stop Sending Market Updates. Start <span className="text-primary">Growing.</span>
          </h2>
          <p className="text-sm text-background/70 max-w-md mx-auto mb-6">
            While other agents send boring emails that get deleted, you'll have a proven system that
            reactivates relationships and generates referrals on autopilot.
          </p>

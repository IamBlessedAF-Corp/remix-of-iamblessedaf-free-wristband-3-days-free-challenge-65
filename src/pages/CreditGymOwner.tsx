...
export default function CreditGymOwner() {
  ...
  const { variant: abVariant } = useABTest("credit_gym_headline");
            ...
            {abVariant === "A" ? (
              <>
                <h1 className="text-3xl md:text-5xl font-black text-foreground leading-[1.1] mb-4 tracking-tight">
                  A Neuroscience-Backed Viral <span className="text-primary">Gratitude Challenge</span><br />That Boosts Retention 2–3x 🧠
                </h1>
                <p className="text-base md:text-lg text-muted-foreground max-w-xl mx-auto mb-4 leading-relaxed">
                  Use <strong className="text-foreground">science-backed gratitude challenges</strong> to keep members engaged.

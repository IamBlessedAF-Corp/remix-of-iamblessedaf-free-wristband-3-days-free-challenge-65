...
const PHASES: RoadmapPhase[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Achievement badges & trophy case", status: "done", priority: "medium", labels: ["temu-ux"], detail: "Tier milestone celebrations with confetti + toast (Silver, Gold, Diamond). Visual badge system in credit tracker." },
      ...
      { title: "Notification bell & in-app alerts", status: "done", priority: "medium", detail: "Real-time notification bell in portal header showing tier unlocks, reposts, blessings, and streak milestones" },
      { title: "Account settings & role switching", status: "done", priority: "high", detail: "Full account management tab: edit profile, social handles, switch affiliate role (10 roles), view referral code" },
      { title: "Diamond Ambassador exclusive page", status: "done", priority: "high", detail: "Premium page at /diamond-ambassador with progress gate at 1,000 wristbands. 50% commission, AI assistant, white-label funnels." },
    ],
  },
  {
    id: "ops",
  ...
  },
  {
    ...
    subtitle: "Email sequences, SMS automation, Soap Opera framework, push notifications",
    status: "active",
    delegationScore: 65,
    items: [
      ...
      { title: "Tier milestone email notifications", status: "done", priority: "high", detail: "Automated Resend emails on Silver/Gold/Diamond tier unlock with styled HTML, credit amounts, and unlocked perks" },
      { title: "Weekly digest email system", status: "done", priority: "high", detail: "Automated Monday digest via pg_cron: weekly reposts, BC balance, streak, tier progress bar, unsubscribe link" },
      { title: "In-app notification center", status: "done", priority: "medium", detail: "Bell icon with unread count, notification categories (tier unlocks, reposts, blessings, streaks), mark-as-read" },
      { title: "Push notification support (web)", status: "done", priority: "high", detail: "Browser Notification API for real-time alerts on BC earned, referral link usage, and tier milestones" },
      { title: "Unsubscribe management", status: "done", priority: "medium", detail: "One-click unsubscribe link in weekly digest, digest_opted_out column in creator_profiles, /unsubscribe-digest page" },

  ...
  const PLATFORMS: PlatformConfig[] = [
    {
      ...
      reward: 30,
      caption: `I just blessed someone with a FREE gratitude wristband 🙏🎁 It literally feeds 11 people when you wear it. Link in bio to get yours FREE 👇\n\n${url}`,
      hashtags: "#IamBlessedAF #GratitudeChallenge #FreeGift #BlessedAF #Gratitude",
      shareUrl: (u, t) => `https://www.tiktok.com/`, // TikTok doesn't have share URL — copy caption
    },
    {
      id: "instagram",
      name: "Instagram",
      ...
      reward: 30,
      caption: `I'm on a mission to feed 11 people just by wearing a wristband 🙏🍽️\n\nI got my FREE "I Am Blessed AF" wristband and YOU can get one too — link in my bio!\n\nEvery wristband = 11 meals donated 🎁\n\n${url}`,
    ...
    },
    {
      ...
      reward: 30,
      caption: `I'm gifting FREE "I Am Blessed AF" wristbands 🎁 Each one feeds 11 people 🍽️\n\nClaim yours (just cover shipping): ${url}\n\n#IamBlessedAF`,
    ...
    },
    {
      ...
      reward: 30,
      caption: `🎁 I'm gifting FREE "I Am Blessed AF" wristbands! Each one feeds 11 people 🍽️\n\nClaim yours here (just cover shipping):\n${url}\n\nSpread the gratitude 🙏 #IamBlessedAF`,
    ...
    },
    {
      ...
      reward: 20,
      caption: `🎁 FREE wristband alert! Claim your "I Am Blessed AF" wristband — each one feeds 11 people 🍽️🙏\n\n${url}`,
    ...
    },
    {
      ...
      color: "bg-foreground text-background",
      reward: 20,
      caption: `Wearing my "I Am Blessed AF" wristband 🙏 Every wristband = 11 meals donated.\n\nGet yours FREE (just cover shipping): ${url}\n\n#IamBlessedAF`,
      hashtags: "#IamBlessedAF #Gratitude",

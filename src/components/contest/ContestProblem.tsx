      ...
      >
        ...
        <div>
          ...
          <p className="text-lg text-muted-foreground">
            ...
            But what if someone paid you <strong>directly per clip</strong>—with a $2.22 guarantee even at 1,000 views?
          </p>
        </div>
        ...
        <div className="bg-primary/10 border border-primary/20 rounded-xl p-6">
          ...
          <div className="space-y-2 text-foreground font-medium">
            <p>• <strong>$2.22 floor</strong> — even a 1,000-view clip pays you $2.22. No minimum threshold BS.</p>
            <p>• <strong>$0.22 per 1,000 views</strong> — that's 7x what TikTok Creator Fund pays.</p>
            <p>• <strong>$22 cap</strong> — keeps the pool fair so more clippers get paid.</p>
          </div>
          <p className="text-lg text-muted-foreground mt-4">
            <strong className="text-primary">The real math:</strong> 10 clips/week at 10k avg views = <strong>$22/week = $88/month</strong>. At 20k avg? <strong>$176/month</strong>. From gratitude content you're already making.
          </p>
        </div>
      </motion.div>
    </div>
